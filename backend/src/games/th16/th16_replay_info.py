...
class TH16StageDetail(BaseModel, StageDetail):
    ...
    season_power: Optional[int] = None
    ...
    def convert_to_dict(self):
        return {
            ...
            "graze": self.graze,
            "season_power": self.season_power,
        }


class TH16ReplayInfo(BaseModel, ReplayInfo):
    name: str = ""
    shot_type: str = ""
    difficulty: int = -1
    total_score: int = Field(..., ge=0, le=15000000000)
    timestamp: datetime
