<template>
  ...
  >
    ...
    <v-col
      class="pa-2 d-flex justify-space-between align-start"
    ...
    >
        ...
        <v-row no-gutters align="baseline" style="min-width: 0">
          ...
          >
            ...
            <div class="d-flex flex-wrap" style="gap: 8px; min-width: 0">
              <v-chip
                ...
                :color="props.replayTable.difficulty.color"
                text-color="white"
                small
              >
          ...
          <v-col cols="12" class="mt-1" style="min-width: 0">
            ...
            >
              ...
              <div
                class="d-flex align-center"
                style="flex: 1 1 auto; overflow: hidden; min-width: 0"
              >
                <!-- コメントテキスト -->
                <div
                ...
                <div
                  ...
                  style="flex-shrink: 0; gap: 8px; min-width: 0"
                >
                  <NuxtLink
      ...
      <div
        class="d-flex align-center"
        style="position: absolute; top: 8px; right: 12px; gap: 8px"
      >
        <span>
          <v-chip
