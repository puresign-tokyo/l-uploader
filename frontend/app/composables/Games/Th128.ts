    ...
    stage_details: {
      ...
      items: replay.replay_meta.stage_details.map((stage) => {
        ...
        return {
          ...
          motivation:
            stage.motivation !== null
              ? String(Math.floor(Number(stage.motivation) / 100)) + "%"
              : "-",
          perfect_freeze:
            stage.perfect_freeze !== null
              ? String(Math.floor(Number(stage.perfect_freeze) / 100)) + "%"
              : "-",
          frozen_area: stage.frozen_area
            ? String(Math.floor(Number(stage.frozen_area))) + "%"
            : "-",
          graze:
