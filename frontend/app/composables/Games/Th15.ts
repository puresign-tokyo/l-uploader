...
export function Th15Table(replay: Th15Replay) {
  ...
  return {
    game_meta: {
      theme_color: "#6A47BE",
      img: {
        thumb: "/images/thumb/th15.png",
        full: "/images/full/th15.png",
        alt: "th15",
      },
      name: "東方紺珠伝 〜 Legacy of Lunatic Kingdom." + game_version,
    },
