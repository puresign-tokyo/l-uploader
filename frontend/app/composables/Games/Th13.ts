...
const spellCardMap: Record<string, { ja: string; en: string }> = {
  ...
  2: {
    ja: "符牒「死蝶の舞　- 桜花 -」",
    en: 'Symbol "Dance of the Dead Butterflies - Cherry Blossoms -"',
  },
  3: {
    ja: "符牒「死蝶の舞　- 桜花 -」",
    en: 'Symbol "Dance of the Dead Butterflies - Cherry Blossoms -"',
  ...
  6: {
    ja: "幽蝶「ゴーストスポット　- 桜花 -」",
    en: 'Ghostly Butterfly "Ghost Spot - Cherry Blossoms -"',
  },
  7: {
    ja: "幽蝶「ゴーストスポット　- 桜花 -」",
    en: 'Ghostly Butterfly "Ghost Spot - Cherry Blossoms -"',
  ...
  8: {
    ja: "冥符「常夜桜」",
    en: 'Nether Sign "Endless Evening Cherry Blossoms"',
  },
  9: {
    ja: "冥符「常夜桜」",
    en: 'Nether Sign "Endless Evening Cherry Blossoms"',
  ...
  12: {
    ja: "桜符「西行桜吹雪」",
    en: 'Cherry Blossom Sign "Saigyou Cherry Blossom Blizzard"',
  },
  13: {
    ja: "桜符「西行桜吹雪」",
    en: 'Cherry Blossom Sign "Saigyou Cherry Blossom Blizzard"',
  ...
  16: {
    ja: "響符「マウンテンエコースクランブル」",
    en: 'Echo Sign "Mountain Echo Scramble"',
  },
  17: {
    ja: "響符「マウンテンエコースクランブル」",
    en: 'Echo Sign "Mountain Echo Scramble"',
  ...
  22: {
    ja: "山彦「ロングレンジエコー」",
    en: 'Mountain Echo "Long-Range Echo"',
  },
  23: {
    ja: "山彦「ロングレンジエコー」",
    en: 'Mountain Echo "Long-Range Echo"',
  ...
  30: {
    ja: "虹符「アンブレラサイクロン」",
    en: 'Rainbow Sign "Umbrella Cyclone"',
  },
  31: {
    ja: "虹符「アンブレラサイクロン」",
    en: 'Rainbow Sign "Umbrella Cyclone"',
  ...
  40: {
    ja: "欲符「稼欲霊招来」",
    en: 'Desire Sign "Saved Up Desire Spirit Invitation"',
  },
  41: {
    ja: "欲符「稼欲霊招来」",
    en: 'Desire Sign "Saved Up Desire Spirit Invitation"',
  ...
  42: {
    ja: "欲霊「スコアデザイアイーター」",
    en: 'Desire Spirit "Score Desire Eater"',
  },
  43: {
    ja: "欲霊「スコアデザイアイーター」",
    en: 'Desire Spirit "Score Desire Eater"',
  ...
  59: {
    ja: "雷矢「ガゴウジサイクロン」",
    en: 'Thunder Arrow "Gagouji\'s Cyclone"',
  },
  60: {
    ja: "雷矢「ガゴウジサイクロン」",
    en: 'Thunder Arrow "Gagouji\'s Cyclone"',
  ...
  66: {
    ja: "投皿「物部の八十平瓮」",
    en: 'Throwing Dishes "Mononobe\'s Eighty Saké Cups"',
  },
  67: {
    ja: "投皿「物部の八十平瓮」",
    en: 'Throwing Dishes "Mononobe\'s Eighty Saké Cups"',
  ...
  70: {
    ja: "炎符「廃仏の炎風」",
    en: 'Blaze Sign "Blazing Winds of Haibutsu"',
  },
  71: {
    ja: "炎符「廃仏の炎風」",
    en: 'Blaze Sign "Blazing Winds of Haibutsu"',
  ...
  82: {
    ja: "仙符「日出ずる処の道士」",
    en: 'Hermit Sign "Taoist of the Land of the Rising Sun"',
  },
  83: {
    ja: "仙符「日出ずる処の道士」",
    en: 'Hermit Sign "Taoist of the Land of the Rising Sun"',
  ...
  84: {
    ja: "仙符「日出ずる処の天子」",
    en: 'Hermit Sign "Emperor of the Land of the Rising Sun"',
  },
  85: {
    ja: "仙符「日出ずる処の天子」",
    en: 'Hermit Sign "Emperor of the Land of the Rising Sun"',
  ...
  90: {
    ja: "秘宝「斑鳩寺の天球儀」",
    en: 'Secret Treasure "Armillary Sphere of Ikaruga-dera"',
  },
  91: {
    ja: "秘宝「斑鳩寺の天球儀」",
    en: 'Secret Treasure "Armillary Sphere of Ikaruga-dera"',
  ...
  93: {
    ja: "秘宝「聖徳太子のオーパーツ」",
    en: 'Secret Treasure "Prince Shotoku\'s Out-of-Place Artifact"',
  },
  94: {
    ja: "光符「救世観音の光後光」",
    en: 'Light Sign "Halo of the Guse Kannon"',
  },
  95: {
    ja: "光符「救世観音の光後光」",
    en: 'Light Sign "Halo of the Guse Kannon"',
  ...
  98: {
    ja: "眼光「十七条のレーザー」",
    en: 'Discernment "Lasers of Seventeen Articles"',
  },
  99: {
    ja: "眼光「十七条のレーザー」",
    en: 'Discernment "Lasers of Seventeen Articles"',
  ...
  100: {
    ja: "神光「逆らう事なきを宗とせよ」",
    en: 'Divine Light "Honor the Avoidance of Defiance"',
  },
  101: {
    ja: "神光「逆らう事なきを宗とせよ」",
    en: 'Divine Light "Honor the Avoidance of Defiance"',
  ...
  102: {
    ja: "「星降る神霊廟」",
    en: '"Falling Stars on Divine Spirit Mausoleum"',
  },
  103: {
    ja: "「星降る神霊廟」",
    en: '"Falling Stars on Divine Spirit Mausoleum"',
  ...
  106: {
    ja: "アンノウン「軌道不明の鬼火」",
    en: 'Unknown "Will-o\'-wisps in Unknown Orbit"',
  },
  107: {
    ja: "アンノウン「姿態不明の空魚」",
    en: 'Unknown "Skyfish with Unknown Shape"',
  },
  108: {
    ja: "アンノウン「原理不明の妖怪玉」",
    en: 'Unknown "Youkai Orb of Unknown Mechanics"',
  },
  109: {
    ja: "壱番勝負「霊長化弾幕変化」",
    en: 'First Duel "Primate Danmaku Transformation"',
  },
  110: {
    ja: "弐番勝負「肉食化弾幕変化」",
    en: 'Second Duel "Carnivorous Danmaku Transformation"',
  },
  111: {
    ja: "参番勝負「延羽化弾幕変化」",
    en: 'Third Duel "Avian Danmaku Transformation"',
  },
  112: {
    ja: "四番勝負「両生化弾幕変化」",
    en: 'Fourth Duel "Amphibian Danmaku Transformation"',
  },
  113: {
    ja: "伍番勝負「鳥獣戯画」",
    en: 'Fifth Duel "Scrolls of Frolicking Animals"',
  },
  114: {
    ja: "六番勝負「狸の化け学校」",
    en: 'Sixth Duel "Tanuki\'s Monstrous School"',
  },
  115: {
    ja: "七番勝負「野生の離島」",
    en: 'Seventh Duel "Wild Deserted Island"',
  },
  116: {
    ja: "変化「まぬけ巫女の偽調伏」",
    en: 'Transformation "Pseudo-Exorcism of the Stupid Shrine Maiden"',
  },
  117: {
    ja: "「マミゾウ化弾幕十変化」",
    en: '"Mamizou Danmaku in Ten Transformations"',
  },
  118: {
    ja: "狢符「満月のポンポコリン」",
    en: 'Raccoon Sign "Full Moon Pompokolin"',
  },
  119: {
    ja: "桜符「桜吹雪地獄」",
    en: 'Cherry Blossom Sign "Cherry Blossom Blizzard Hell"',
  },
  120: {
    ja: "山彦「ヤマビコの本領発揮エコー」",
    en: 'Mountain Echo "Yamabiko\'s Specialty Echo Demonstration"',
  },
  121: { ja: "毒爪「死なない殺人鬼」", en: 'Poison Nail "Undead Murderer"' },
  122: {
    ja: "道符「ＴＡＯ胎動　〜道〜」",
    en: 'Taoist Sign "TAO Fetal Movement ~Dao~"',
  },
  123: { ja: "怨霊「入鹿の雷」", en: 'Vengeful Spirit "Iruka\'s Thunder"' },
  124: {
    ja: "聖童女「太陽神の贄」",
    en: 'Saint Girl "Sun Goddess\'s Sacrifice"',
  },
    ...
    stage_details: {
      ...
      items: replay.replay_meta.stage_details.map((stage) => {
        ...
        if (stage.bombs !== null && stage.bomb_pieces !== null) {
          bombLabel =
            String(stage.bombs) + " + (" + String(stage.bomb_pieces) + "/8)";
        } else {
          bombLabel = "-";
        }
