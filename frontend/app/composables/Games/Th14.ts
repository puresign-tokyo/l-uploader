...
const spellCardMap: Record<string, { ja: string; en: string }> = {
  ...
  8: {
    ja: "鱗符「逆鱗の荒波」",
    en: 'Scale Sign "Raging Waves of the Reversed Scale"',
  },
  9: {
    ja: "鱗符「逆鱗の大荒波」",
    en: 'Scale Sign "Great Raging Waves of the Reversed Scale"',
  },
  ...
  18: {
    ja: "飛頭「マルチプリケイティブヘッド」",
    en: 'Flying Head "Multiplicative Head"',
  },
  19: {
    ja: "飛頭「マルチプリケイティブヘッド」",
    en: 'Flying Head "Multiplicative Head"',
  ...
  28: {
    ja: "変身「トライアングルファング」",
    en: 'Transformation "Triangle Fang"',
  },
  29: {
    ja: "変身「トライアングルファング」",
    en: 'Transformation "Triangle Fang"',
  ...
  40: {
    ja: "平曲「祇園精舎の鐘の音」",
    en: 'Heikyoku "Sounds of Jetavana\'s Bell"',
  },
  41: {
    ja: "平曲「祇園精舎の鐘の音」",
    en: 'Heikyoku "Sounds of Jetavana\'s Bell"',
  ...
  46: {
    ja: "怨霊「平家の大怨霊」",
    en: 'Vengeful Spirit "Great Vengeful Spirit of Taira"',
  },
  47: {
    ja: "怨霊「平家の大怨霊」",
    en: 'Vengeful Spirit "Great Vengeful Spirit of Taira"',
  ...
  50: {
    ja: "楽符「凶悪な五線譜」",
    en: 'Music Sign "Malicious Musical Score"',
  },
  51: { ja: "楽符「ダブルスコア」", en: 'Music Sign "Double Score"' },
  52: {
    ja: "琴符「諸行無常の琴の音」",
    en: 'Koto Sign "Sounds of Anicca\'s Koto"',
  },
  53: {
    ja: "琴符「諸行無常の琴の音」",
    en: 'Koto Sign "Sounds of Anicca\'s Koto"',
  ...
  60: {
    ja: "箏曲「下克上送箏曲」",
    en: 'Koto Music "Social Upheaval Koto Music Complement"',
  },
  61: {
    ja: "箏曲「下克上送箏曲」",
    en: 'Koto Music "Social Upheaval Koto Music Complement"',
  ...
  62: {
    ja: "箏曲「下克上レクイエム」",
    en: 'Koto Music "Social Upheaval Requiem"',
  },
  63: {
    ja: "箏曲「下克上レクイエム」",
    en: 'Koto Music "Social Upheaval Requiem"',
  ...
  68: {
    ja: "逆符「鏡の国の弾幕」",
    en: 'Reverse Sign "Danmaku Through the Looking-Glass"',
  },
  69: {
    ja: "逆符「鏡の国の弾幕」",
    en: 'Reverse Sign "Danmaku Through the Looking-Glass"',
  ...
  70: {
    ja: "逆符「イビルインザミラー」",
    en: 'Reverse Sign "Evil in the Mirror"',
  },
  71: {
    ja: "逆符「イビルインザミラー」",
    en: 'Reverse Sign "Evil in the Mirror"',
  ...
  74: {
    ja: "逆符「天下転覆」",
    en: 'Reverse Sign "Overturning All Under Heaven"',
  },
  75: {
    ja: "逆符「天下転覆」",
    en: 'Reverse Sign "Overturning All Under Heaven"',
  ...
  76: {
    ja: "逆弓「天壌夢弓」",
    en: 'Reverse Bow "Dream Bow of Heaven & Earth"',
  },
  77: {
    ja: "逆弓「天壌夢弓」",
    en: 'Reverse Bow "Dream Bow of Heaven & Earth"',
  ...
  78: {
    ja: "逆弓「天壌夢弓の詔勅」",
    en: 'Reverse Bow "Decree of the Dream Bow of Heaven & Earth"',
  },
  79: {
    ja: "逆弓「天壌夢弓の詔勅」",
    en: 'Reverse Bow "Decree of the Dream Bow of Heaven & Earth"',
  ...
  80: {
    ja: "逆転「リバースヒエラルキー」",
    en: 'Turnabout "Reverse Hierarchy"',
  },
  81: {
    ja: "逆転「リバースヒエラルキー」",
    en: 'Turnabout "Reverse Hierarchy"',
  ...
  86: {
    ja: "小弾「小人の茨道」",
    en: 'Small Barrage "Inchling\'s Thorny Path"',
  },
  87: {
    ja: "小弾「小人の茨道」",
    en: 'Small Barrage "Inchling\'s Thorny Path"',
  ...
  111: {
    ja: "二鼓「怨霊アヤノツヅミ」",
    en: 'Second Drum "Vengeful Spirit Aya-no-Tsuzumi"',
  },
  112: {
    ja: "三鼓「午前零時のスリーストライク」",
    en: 'Third Drum "Three Strikes at Midnight"',
  },
  113: { ja: "死鼓「ランドパーカス」", en: 'Death Drum "Land Percuss"' },
  114: { ja: "五鼓「デンデン太鼓」", en: 'Fifth Drum "Den-Den Daiko"' },
  115: {
    ja: "六鼓「オルタネイトスティッキング」",
    en: 'Sixth Drum "Alternate Sticking"',
  },
  116: {
    ja: "七鼓「高速和太鼓ロケット」",
    en: 'Seventh Drum "High Speed Taiko Rocket"',
  },
