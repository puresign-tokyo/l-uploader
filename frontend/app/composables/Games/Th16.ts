...
const spellCardMap: Record<string, { ja: string; en: string }> = {
  ...
  2: {
    ja: "蝶符「アゲハの鱗粉」",
    en: 'Butterfly Sign "Swallowtail\'s Scales"',
  },
  3: {
    ja: "蝶符「アゲハの鱗粉」",
    en: 'Butterfly Sign "Swallowtail\'s Scales"',
  ...
  4: {
    ja: "蝶符「フラッタリングサマー」",
    en: 'Butterfly Sign "Fluttering Summer"',
  },
  5: {
    ja: "蝶符「フラッタリングサマー」",
    en: 'Butterfly Sign "Fluttering Summer"',
  ...
  6: {
    ja: "蝶符「真夏の羽ばたき」",
    en: 'Butterfly Sign "Midsummer Wingbeats"',
  },
  7: {
    ja: "蝶符「真夏の羽ばたき」",
    en: 'Butterfly Sign "Midsummer Wingbeats"',
  ...
  10: {
    ja: "雨符「呪われた柴榑雨」",
    en: 'Rain Sign "Cursed Torrential Rain"',
  },
  11: {
    ja: "雨符「呪われた柴榑雨」",
    en: 'Rain Sign "Cursed Torrential Rain"',
  ...
  12: {
    ja: "刃符「山姥の包丁研ぎ」",
    en: 'Blade Sign "Yamanba\'s Kitchen Knife Sharpening"',
  },
  13: {
    ja: "刃符「山姥の包丁研ぎ」",
    en: 'Blade Sign "Yamanba\'s Kitchen Knife Sharpening"',
  ...
  14: {
    ja: "刃符「山姥の鬼包丁研ぎ」",
    en: 'Blade Sign "Yamanba\'s Oni Kitchen Knife Sharpening"',
  },
  15: {
    ja: "刃符「山姥の鬼包丁研ぎ」",
    en: 'Blade Sign "Yamanba\'s Oni Kitchen Knife Sharpening"',
  ...
  16: {
    ja: "尽符「マウンテンマーダー」",
    en: 'Blade Exhaustion Sign "Mountain Murder"',
  },
  17: {
    ja: "尽符「マウンテンマーダー」",
    en: 'Blade Exhaustion Sign "Mountain Murder"',
  ...
  18: {
    ja: "尽符「ブラッディマウンテンマーダー」",
    en: 'Blade Exhaustion Sign "Bloody Mountain Murder"',
  },
  19: {
    ja: "尽符「ブラッディマウンテンマーダー」",
    en: 'Blade Exhaustion Sign "Bloody Mountain Murder"',
  ...
  20: {
    ja: "春符「サプライズスプリング」",
    en: 'Spring Sign "Surprise Spring"',
  },
  21: {
    ja: "春符「サプライズスプリング」",
    en: 'Spring Sign "Surprise Spring"',
  ...
  29: {
    ja: "独楽「カールアップアンドダイ」",
    en: 'Spinning Top "Curl Up and Die"',
  },
  30: {
    ja: "狛符「独り阿吽の呼吸」",
    en: 'Koma Sign "Solitary A-Um Breathing"',
  },
  31: {
    ja: "狛符「独り阿吽の呼吸」",
    en: 'Koma Sign "Solitary A-Um Breathing"',
  ...
  40: {
    ja: "魔符「ペットの巨大弾生命体」",
    en: 'Magic Sign "Gigantic Pet Bullet Lifeform"',
  },
  41: {
    ja: "魔符「ペットの巨大弾生命体」",
    en: 'Magic Sign "Gigantic Pet Bullet Lifeform"',
  ...
  46: {
    ja: "竹符「バンブースピアダンス」",
    en: 'Bamboo Sign "Bamboo Spear Dance"',
  },
  47: {
    ja: "竹符「バンブースピアダンス」",
    en: 'Bamboo Sign "Bamboo Spear Dance"',
  ...
  48: {
    ja: "竹符「バンブークレイジーダンス」",
    en: 'Bamboo Sign "Bamboo Crazy Dance"',
  },
  49: {
    ja: "竹符「バンブークレイジーダンス」",
    en: 'Bamboo Sign "Bamboo Crazy Dance"',
  ...
  50: {
    ja: "茗荷「フォゲットユアネーム」",
    en: 'Myōga Ginger "Forget Your Name"',
  },
  51: {
    ja: "茗荷「フォゲットユアネーム」",
    en: 'Myōga Ginger "Forget Your Name"',
  ...
  54: {
    ja: "笹符「タナバタスターフェスティバル」",
    en: 'Broadleaf Sign "Tanabata Star Festival"',
  },
  55: {
    ja: "笹符「タナバタスターフェスティバル」",
    en: 'Broadleaf Sign "Tanabata Star Festival"',
  ...
  68: {
    ja: "狂舞「狂乱天狗怖し」",
    en: 'Mad Dance "Frenzied Tengu-Frightening"',
  },
  69: {
    ja: "狂舞「狂乱天狗怖し」",
    en: 'Mad Dance "Frenzied Tengu-Frightening"',
  ...
  73: {
    ja: "後符「絶対秘神の後光」",
    en: 'Back Sign "Halo of the Absolute Secret God"',
  },
  74: {
    ja: "裏夏「スコーチ・バイ・ホットサマー」",
    en: 'Hidden Summer "Scorch By Hot Summer"',
  },
  75: {
    ja: "裏夏「スコーチ・バイ・ホットサマー」",
    en: 'Hidden Summer "Scorch By Hot Summer"',
  ...
  76: {
    ja: "裏夏「異常猛暑の焦土」",
    en: 'Hidden Summer "Scorched Earth of Abnormal Intense Heat"',
  },
  77: {
    ja: "裏夏「異常猛暑の焦土」",
    en: 'Hidden Summer "Scorched Earth of Abnormal Intense Heat"',
  ...
  80: {
    ja: "裏秋「異常枯死の餓鬼」",
    en: 'Hidden Fall "Preta of Abnormal Blight"',
  },
  81: {
    ja: "裏秋「異常枯死の餓鬼」",
    en: 'Hidden Fall "Preta of Abnormal Blight"',
  ...
  84: {
    ja: "裏冬「異常降雪の雪だるま」",
    en: 'Hidden Winter "Snowman of Abnormal Snowfall"',
  },
  85: {
    ja: "裏冬「異常降雪の雪だるま」",
    en: 'Hidden Winter "Snowman of Abnormal Snowfall"',
  ...
  88: {
    ja: "裏春「異常落花の魔術使い」",
    en: 'Hidden Spring "Black Magician of Abnormal Falling Petals"',
  },
  89: {
    ja: "裏春「異常落花の魔術使い」",
    en: 'Hidden Spring "Black Magician of Abnormal Falling Petals"',
  ...
  90: {
    ja: "「裏・ブリージーチェリーブロッサム」",
    en: '"Hidden Breezy Cherry Blossom"',
  },
  91: {
    ja: "「裏・ブリージーチェリーブロッサム」",
    en: '"Hidden Breezy Cherry Blossom"',
  ...
  107: {
    ja: "狂舞「クレイジーバックダンス」",
    en: 'Mad Dance "Crazy Backup Dance"',
  },
  108: { ja: "弾舞「二つ目の台風」", en: 'Bullet Dance "Twin Typhoons"' },
  109: {
    ja: "秘儀「リバースインヴォーカー」",
    en: 'Secret Ceremony "Reverse Invoker"',
  },
  110: {
    ja: "秘儀「裏切りの後方射撃」",
    en: 'Secret Ceremony "Rear Shots of Betrayal"',
  },
  111: { ja: "秘儀「弾幕の玉繭」", en: 'Secret Ceremony "Danmaku Dupion"' },
  112: { ja: "秘儀「穢那の火」", en: 'Secret Ceremony "Fire of Ena"' },
  113: {
    ja: "秘儀「後戸の狂言」",
    en: 'Secret Ceremony "Kyōgen of the Back Door"',
  },
  114: {
    ja: "秘儀「マターラドゥッカ」",
    en: 'Secret Ceremony "Matarah Dukkha"',
  },
  115: {
    ja: "秘儀「七星の剣」",
    en: 'Secret Ceremony "Sword of the Seven Stars"',
  },
  116: {
    ja: "秘儀「無縁の芸能者」",
    en: 'Secret Ceremony "Performers Unattached to Society"',
  },
...
const shotTypeMap: Record<string, { label: string; color: string }> = {
  ...
  CirnoSpring: {
    label: "チルノ(春)",
    color: useTableUtils().convertCharacter("Cirno").color,
  },
  CirnoSummer: {
    label: "チルノ(夏)",
    color: useTableUtils().convertCharacter("Cirno").color,
  ...
  AyaSpring: {
    label: "文(春)",
    color: useTableUtils().convertCharacter("Aya").color,
  },
  AyaSummer: {
    label: "文(夏)",
    color: useTableUtils().convertCharacter("Aya").color,
    ...
    stage_details: {
      ...
      items: replay.replay_meta.stage_details.map((stage) => {
        ...
        if (stage.bombs !== null && stage.bomb_pieces !== null) {
          bombLabel =
            String(stage.bombs) + " + (" + String(stage.bomb_pieces) + "/5)";
        } else {
          bombLabel = "-";
        }
        ...
        if (stage.season_power === null) {
          ...
          seasonPowerLabel =
            "Lv5 + " + String(Number(stage.season_power) - 840) + "/300";
        } else if (Number(stage.season_power) - 590 >= 0) {
          seasonPowerLabel =
            "Lv4 + " + String(Number(stage.season_power) - 590) + "/250";
        } else if (Number(stage.season_power) - 390 >= 0) {
          seasonPowerLabel =
            "Lv3 + " + String(Number(stage.season_power) - 390) + "/200";
        } else if (Number(stage.season_power) - 230 >= 0) {
          seasonPowerLabel =
            "Lv2 + " + String(Number(stage.season_power) - 230) + "/160";
        } else if (Number(stage.season_power) - 100 >= 0) {
          seasonPowerLabel =
            "Lv1 + " + String(Number(stage.season_power) - 100) + "/130";
        } else {
